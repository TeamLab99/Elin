// exact copy of VIScriptComponentEditor.cs except for lines 25, 27 and 410
...
namespace VInspector
{
    ...
    class VIScriptableObjectEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            void drawBody()
            {
                ...
                void drawCurProperty()
                {
                    ...
                    if (!(target.GetType().GetField(curProperty.name, maxBindingFlags) is FieldInfo field)) return;
                    ...
                    if (tabAttribute != null) { drawingTabPath = tabAttribute.name; drawingFoldoutPath = ""; }
                    if (endTabAttribute != null) { drawingTabPath = ""; drawingFoldoutPath = ""; }
                    ...
                    if (field.GetCustomAttribute<SpaceAttribute>() is SpaceAttribute spaceAttribute)
                        Space(spaceAttribute.space);
        ...
        public void OnEnable()
        {
            ...
            if (datasByTarget.ContainsKey(target))
